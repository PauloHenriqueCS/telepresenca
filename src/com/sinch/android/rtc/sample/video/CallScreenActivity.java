...
public class CallScreenActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RelativeLayout Localvideo = (RelativeLayout) findViewById(R.id.localVideo);
        final LinearLayout Remotevideo = (LinearLayout) findViewById(R.id.remoteVideo);
        ButtonHide = (ToggleButton) findViewById(R.id.hidebutton);
        ButtonHide.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
